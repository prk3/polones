# builds polones-dekstop for linux arm64
# expects:
...
CMD ["sh", "-c", ". \"$HOME/.cargo/env\" && cargo build --target aarch64-unknown-linux-gnu --features sdl2/static-link,sdl2/use-pkgconfig --profile release"]
